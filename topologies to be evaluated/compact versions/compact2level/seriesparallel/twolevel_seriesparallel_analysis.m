...
for sw_frequency = 1050:4000:100050
    ...
    numberelement = numel(twolevelseriesparallel_interleaved.get('Ids1_1').data);
...
save('topologyB_n11','Capacitor_values','THDV_2levelseries_IGBTVab1','THDV_2levelseries_IGBTIa1'...
