...
%     
%     
%     phasecurrentstime = twolevelseriesparallel_interleaved.get('Phase_currents1').time;
%     Ia1 = twolevelseriesparallel_interleaved.get('Phase_currents1').signals(1).values;
%     Ia3 = twolevelseriesparallel_interleaved.get('Phase_currents3').signals(1).values; 
%     
%     Vab1 = twolevelseriesparallel_interleaved.get('LL_voltages1').signals(1).values;
...
% clear('Capacitor_values','THD_Vab1','THD_Ia1','THD_Vab3','THD_Ia3'...
%     ,'ripple1vector','ripple1percent','ripple2vector','ripple2percent','DCLINK_Vc1rms','DCLINK_Vc2rms','DCLINK_Ic1rms','DCLINK_Ic2rms'...
%     ,'DCLINK_cap1_voltage_spectrum_abs','DCLINK_cap1_current_spectrum_abs','DCLINK_cap2_voltage_spectrum_abs'...
%     ,'DCLINK_cap2_current_spectrum_abs','LLab1_voltages_spectrum_abs','LLbc1_voltages_spectrum_abs','LLca1_voltages_spectrum_abs',...
%     'Ia1_Spectrum_abs','Ib1_Spectrum_abs','Ic1_Spectrum_abs','LLab3_voltages_spectrum_abs','LLbc3_voltages_spectrum_abs','LLca3_voltages_spectrum_abs'...
...
%     phasecurrentstime = twolevelseriesparallel_interleaved.get('Phase_currents1').time;
%     Ia1 = twolevelseriesparallel_interleaved.get('Phase_currents1').signals(1).values;
%     Ia2 = twolevelseriesparallel_interleaved.get('Phase_currents2').signals(1).values;    
%     Ia3 = twolevelseriesparallel_interleaved.get('Phase_currents3').signals(1).values;
%     Ia4 = twolevelseriesparallel_interleaved.get('Phase_currents4').signals(1).values;
%     
%     Vab1 = twolevelseriesparallel_interleaved.get('LL_voltages1').signals(1).values;
...
%     save(savename,'Capacitor_values','THD_Vab1','THD_Ia1','THD_Vab3','THD_Ia3','THD_Vab2','THD_Ia2','THD_Vab4','THD_Ia4'...
%     ,'ripple1vector','ripple1percent','ripple2vector','ripple2percent','DCLINK_Vc1rms','DCLINK_Vc2rms','DCLINK_Ic1rms','DCLINK_Ic2rms'...
%     ,'DCLINK_cap1_voltage_spectrum_abs','DCLINK_cap1_current_spectrum_abs','DCLINK_cap2_voltage_spectrum_abs'...
%     ,'DCLINK_cap2_current_spectrum_abs','LLab1_voltages_spectrum_abs','LLbc1_voltages_spectrum_abs','LLca1_voltages_spectrum_abs',...
%     'Ia1_Spectrum_abs','Ib1_Spectrum_abs','Ic1_Spectrum_abs','LLab3_voltages_spectrum_abs','LLbc3_voltages_spectrum_abs','LLca3_voltages_spectrum_abs'...
...
%     clear('Capacitor_values','THD_Vab1','THD_Ia1','THD_Vab3','THD_Ia3','THD_Vab2','THD_Ia2','THD_Vab4','THD_Ia4'...
%     ,'ripple1vector','ripple1percent','ripple2vector','ripple2percent','DCLINK_Vc1rms','DCLINK_Vc2rms','DCLINK_Ic1rms','DCLINK_Ic2rms'...
%     ,'DCLINK_cap1_voltage_spectrum_abs','DCLINK_cap1_current_spectrum_abs','DCLINK_cap2_voltage_spectrum_abs'...
%     ,'DCLINK_cap2_current_spectrum_abs','LLab1_voltages_spectrum_abs','LLbc1_voltages_spectrum_abs','LLca1_voltages_spectrum_abs',...
%     'Ia1_Spectrum_abs','Ib1_Spectrum_abs','Ic1_Spectrum_abs','LLab3_voltages_spectrum_abs','LLbc3_voltages_spectrum_abs','LLca3_voltages_spectrum_abs'...
