...
set_param('three_level_spwm', 'StopTime', 'stop_time')  % duration of the simulation
set_param('three_level_spwm/powergui','SampleTime','Sampling_time'); % sampling frequency of the simulation
